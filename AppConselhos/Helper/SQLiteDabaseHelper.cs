...
namespace AppConselhos.Helper
{
    ...
    public class SQLiteDatabaseHelper
    {
        ...
        public SQLiteDatabaseHelper(string path)
        {
            ...
            _conn.CreateTableAsync<Conselho>().Wait();
        }


        // Aqui é o metódo que fará a inserção de um novo registro na tabela
        public Task<int> Insert(Conselho p)
        {
        ...
        public Task<List<Conselho>> GetAll()
        {
            return _conn.Table<Conselho>().ToListAsync();
        }

        // Aqui é o método que fará a exclusão do registro na tabela pelo id.
        public Task<int> Delete(int id)
        {
            return _conn.Table<Conselho>().DeleteAsync(i => i.Id == id);
        }
